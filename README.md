...
- `Litematic-建材编辑器-1.0.0-setup.exe`：安装版，会创建开始菜单和桌面快捷方式。
- `Litematic-建材编辑器-1.0.0-portable.exe`：便携版，复制后直接运行，不需要安装 Node.js。
...
- 显示方块中文名、Minecraft ID、所需数量和本地图标/颜色回退。
...
| `tests/` | NBT round-trip、替换属性、形状和投影回归测试 |
